...
- **Application** refers to Currency Converter, the software program provided by the Company.

- **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Currency Converter.
...
- By email: sysxdev@protonmail.com
